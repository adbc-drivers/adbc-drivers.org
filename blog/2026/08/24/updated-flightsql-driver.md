...
[^versioning]: Publishing this build downstream means the 1.12.1 version number is now taken outside of the upstream release sequence. If an official patch release for the 1.12 minor release happens later on, we will work with the ADBC maintainers on how best to handle the overlap.
