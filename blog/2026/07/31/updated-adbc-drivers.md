...
**[Amazon Redshift driver](https://github.com/adbc-drivers/redshift) version [1.5.0](https://adbc-drivers.org/drivers/redshift/v1.5.0)**
...
**[Microsoft SQL Server driver](https://github.com/adbc-drivers/mssql) version [1.6.0](https://adbc-drivers.org/drivers/mssql/v1.6.0)**

- Support dictionary/null binding
- Implement experimental trace propagation

**[Snowflake driver](https://github.com/adbc-drivers/snowflake) version [1.12.0](https://adbc-drivers.org/drivers/snowflake/v1.12.0)**

- Optimize GetObjects metadata query performance

**[Trino driver](https://github.com/adbc-drivers/trino) version [0.5.1](https://adbc-drivers.org/drivers/trino/v0.5.1)**
