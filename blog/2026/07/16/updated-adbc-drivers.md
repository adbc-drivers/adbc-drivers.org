...
**[ADBC Driver for Apache Spark](https://github.com/adbc-drivers/spark) version [0.1.0-alpha.3](/drivers/spark/v0.1.0-alpha.3.md)**
...
**[ADBC Driver for BigQuery](https://github.com/adbc-drivers/bigquery) version [1.12.1](/drivers/bigquery/v1.12.1.md)**

- Bumped Go version to address security vulnerabilities

**[ADBC Driver for Databricks](https://github.com/adbc-drivers/databricks) version [0.1.3](/drivers/databricks/v0.1.3.md)**

- Bumped Go version to address security vulnerabilities

**[ADBC Driver for DuckDB Quack](https://github.com/adbc-drivers/quack) version [0.1.0-alpha.2](/drivers/quack/v0.1.0-alpha.2.md)**

- Bumped DuckDB from 1.5.3 to 1.5.4

**[ADBC Driver for MySQL/MariaDB](https://github.com/adbc-drivers/mysql) version [0.5.0](/drivers/mysql/v0.5.0.md)**
...
**[ADBC Driver for Oracle Database](https://docs.columnar.tech/drivers/oracle) version [0.6.1](https://docs.columnar.tech/drivers/oracle/v0.6.1)**
