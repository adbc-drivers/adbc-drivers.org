...
For more details, see the [full changelog](mssql-v1-4-0). To learn more about how to use the driver, check out the [documentation](/drivers/mssql/v1.4.0.md) and [quickstarts](https://github.com/columnar-tech/adbc-quickstarts).
