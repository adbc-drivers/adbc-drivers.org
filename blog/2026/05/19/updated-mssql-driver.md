...
For more details, see the [full changelog](https://adbc-drivers.org/drivers/mssql/changelog#v1-4-0-2026-05-19). To learn more about how to use the driver, check out the [documentation](https://adbc-drivers.org/drivers/mssql/v1.4.0) and [quickstarts](https://github.com/columnar-tech/adbc-quickstarts).
