...
With strong foundations—and now strong scaffolding—ADBC is ready for its next stage of growth. To learn more or get involved, visit us on GitHub at [adbc-drivers](https://github.com/adbc-drivers) or email us at [hello@adbc-drivers.org](mailto:hello@adbc-drivers.org).
