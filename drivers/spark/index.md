...
timestamp[us] (with time zone) ⚠️ [^2]
...
timestamp[us] (with time zone) ⚠️ [^3] [^4] [^5] [^6]

</td>
<td style="text-align: center;">

timestamp[us], timestamp[us] (with time zone) ⚠️ [^4]
...
[^2]: In our testing, the Livy SQL backend loses fractional seconds when returning timestamp values
[^3]: The Livy backend does not support TIMESTAMP_NTZ
[^4]: The HiveServer2 backend cannot differentiate between TIMESTAMP and TIMESTAMP_NTZ
[^5]: Spark 3.5 + Hive 3 does not support TIMESTAMP_NTZ
[^6]: select is not supported
[^7]: Return type is inconsistent depending on how the query was written
[^8]: Negative scales are not supported
