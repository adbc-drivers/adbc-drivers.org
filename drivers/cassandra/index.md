...
{badge-primary}`Driver Version|v0.1.0-alpha.2` {badge-secondary}`Release Date|2026-09-09` {badge-success}`Tested With|Apache Cassandra 5.0` {badge-success}`Tested With|DataStax Enterprise 6.9` {badge-success}`Tested With|ScyllaDB 2026.3`
...
<table class="docutils data align-default" style="width: 100%">
  ...
  <thead>
    <tr>
      ...
      <th style="text-align: center;">ScyllaDB</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
<th colspan="2" style="text-align: center;">ScyllaDB Type</th>
</tr>
<tr>
