...
(driver-snowflake-v1.12.0)=
# Snowflake Driver v1.12.0

[{badge-primary}`Driver Version|v1.12.0`](#driver-snowflake-v1.12.0 "Permalink") {badge-secondary}`Release Date|2026-07-30` {badge-success}`Tested With|Snowflake 10`
...
GEOGRAPHY (ingest auto-detect), GEOMETRY, GEOMETRY (ingest auto-detect)
...
GEOGRAPHY (ingest geoarrow.wkt), GEOMETRY (ingest geoarrow.wkt)
