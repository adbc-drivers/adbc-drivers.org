...
(driver-clickhouse-v0.1.1)=
# ClickHouse Driver v0.1.1

[{badge-primary}`Driver Version|v0.1.1`](#driver-clickhouse-v0.1.1 "Permalink") {badge-secondary}`Release Date|2026-09-02` {badge-success}`Tested With|ClickHouse 26.8`
...
<th colspan="1" style="text-align: center;">ClickHouse Type</th>
</tr>
<tr>
...
[^4]: DateTime64 supports dates through 2299, but Arrow nanosecond timestamps end in 2262
[^5]: DateTime64(9) and Arrow nanosecond timestamps have limited range (1900 to 2262)
[^6]: ClickHouse Time type is not supported in Arrow format export
