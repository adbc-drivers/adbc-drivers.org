...
(driver-mssql-v1.6.0)=
# Microsoft SQL Server Driver v1.6.0

:::{note}
This project is not associated with Microsoft.
:::

[{badge-primary}`Driver Version|v1.6.0`](#driver-mssql-v1.6.0 "Permalink") {badge-secondary}`Release Date|2026-07-30` {badge-success}`Tested With|Microsoft SQL Server 2022` {badge-success}`Tested With|Microsoft SQL Server 2025` {badge-success}`Tested With|Fabric Data Warehouse azure`
...
- Microsoft SQL Server `17.0.4065.4 Enterprise Evaluation Edition (64-bit)`
